...
const definedHardWordsNotYetAddedWithPossibleDuplicates = [
...
const definedHardWordsAlreadyAdded = [
  {
    word: "novice",
  ...
  { word: "concomitant", definition: "naturally following or accompanying" },
  ...
  {
    word: "didactic",
    definition: "intended to teach, particularly while giving moral instruction"
  },
  ...
  { word: "egregious", definition: "outrageously bad or reprehensible" },
  ...
  { word: "platitude", definition: "a dull or obvious remark, used too often to be meaningful" },
  ...
  { word: "trenchant", definition: "incisive and forceful in thought or style" },
  ...
  { word: "ubiquitous", definition: "Found or existing everywhere" },
  ...
  { word: "bowdlerize", definition: "edit by omitting or modifying parts considered indelicate" },
  {
    word: "esoteric",
    definition:
      "understandable only by only a small number of people with a specialized knowledge or interest"
  },
  ...
  { word: "fulsome", definition: "excessively complimentary or flattering" },
  ...
  { word: "Senescence", definition: "Process of deterioration due to aging" },
  {
    word: "tangible",
    definition: "Something real that can be touched or experienced, not imaginary"
  },
  { word: "scintillating", definition: "Brilliantly lively and exciting" },
  {
    word: "arcadia",
    definition:
      "An image or idea of life in the countryside that is believed to be perfect. Derived from the Greek province of the same name"
  },
  { word: "voracious", definition: "Having a huge appetite for something (e.g. food, reading)" }
];

module.exports = {
  undefinedHardWordsAlreadyAdded,
  definedHardWordsNotYetAddedWithPossibleDuplicates
};
